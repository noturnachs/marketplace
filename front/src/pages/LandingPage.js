    ...
    <div className="min-h-screen bg-primary">
      ...
      <main className="max-w-6xl mx-auto px-6 py-24">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 mt-16 sm:mt-24 bg-secondary/30 rounded-2xl p-6 sm:p-8"
        >
          {[
            ...
            <motion.div key={i} variants={fadeInUp} className="text-center">
              ...
              <div className="text-sm sm:text-base text-textSecondary">
                {stat.label}
              </div>
            </motion.div>
          ))}
        ...
        >
          {[
            ...
            },
            {
              ...
              features: ["Gaming Accounts", "Social Media", "Premium Services"],
            },
            {
              title: "24/7 Support",
